...
# NeoEyes 1.4.0 对应的 Crimson Desert 1.18.01 游戏主程序哈希。
...
EXPECTED_ASSET_SHA256 = {
    "characterinfo.pabgb": "D8FE4973548BEB87ACA61A5910DD8CE912FF340B703AE80D711E14B2451BDDB1",
    "characterinfo.pabgh": "E791D776777CD7EB7857079A78E7996E07D74F9C6037E317F1A892E3E9B9F56B",
    "localizationstring_zho-cn.paloc": (
        "B8F209C4AF224E4BCF103961BA72EDB8E8722DCAA8B9D04A9CB234874EFC04DF"
    ),
}

# 目标 NeoEyes 1.4.0 样本和生成结果的严格数量基线。
EXPECTED_NEOEYES_SHA256 = (
    "D0036FE6755728DFC1C5531793477A62D66431CE2C49B916CED8DCD7B8D2E40D"
)
EXPECTED_CHARACTER_ROWS = 7_239
EXPECTED_OFFICIAL_NAMES = 7_075
EXPECTED_PALOC_ROWS = 190_595
...
def main() -> int:
    ...
    if EXPECTED_OFFICIAL_NAMES and len(official_names) != EXPECTED_OFFICIAL_NAMES:
